...
class GradesControllerTest < ActionController::TestCase
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post :create, grade: { course_id: @grade.course_id, discipline_id: @grade.discipline_id, teacher_id: @grade.teacher_id }
    end
  ...
  test "should update grade" do
    put :update, id: @grade, grade: { course_id: @grade.course_id, discipline_id: @grade.discipline_id, teacher_id: @grade.teacher_id }
    assert_redirected_to grade_path(assigns(:grade))
  end
